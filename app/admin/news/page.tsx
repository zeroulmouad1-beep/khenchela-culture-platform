        ...
        {showForm && (
          <div className="rounded-xl border p-6 mb-6" style={{ backgroundColor: INDIGO_MEDIUM, borderColor: INDIGO_LIGHT }}>
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => { setShowForm(false); setEditingId(null); setForm(emptyNews) }} style={{ color: '#a89070' }}>
                <X size={20} />
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="flex items-end">
                <label className="flex items-center gap-2 cursor-pointer" style={{ fontFamily: 'Tajawal, sans-serif' }}>
                  ...
                  />
                  <span className="text-sm" style={{ color: '#d4c4a8' }}>منشور</span>
                </label>
              </div>
            </div>
            <div className="mb-4">
                      ...
                      <td className="px-4 py-3">
                        <span
                          ...
                          style={{
                            ...
                            color: item.published ? '#22C55E' : '#a89070',
